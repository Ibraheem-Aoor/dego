    ...
    <script>
        ...
        $(document).on('ready', function() {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route('company.car.booking.search', ['status' => $status, 'car' => $car_id]) }}",
            ...
            $(document).on('click', '#filter_button', function() {
                ...
                datatable.ajax.url("{{ route('admin.all.booking.search', $status) }}" + "?filterStatus=" +
            ...
            $(document).on('click', '.complete-multiple', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('company.car.booking.completed.multiple') }}",
                    data: {
                        strIds: strIds
                    },
                    datatType: 'json',
            ...
            $(document).on('click', '.refund-multiple', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('company.car.booking.refund.multiple') }}",
                    data: {
                        strIds: strIds
                    },
                    datatType: 'json',
