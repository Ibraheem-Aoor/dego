                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Cars')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Car List')</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Active Cars')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalActiveCar }}</span>
                                <span class="text-body fs-5 ms-1">{{ 'from ' . $totalCars }}</span>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Inactive Car')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalInactiveCar }}</span>
                                <span class="text-body fs-5 ms-1">{{ 'from ' . $totalCars }}</span>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Today's Created Car")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="@lang('Search Cars')"
                            aria-label="@lang('Search Cars')" autocomplete="off">
                    </div>
                </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered filter_dropdown"
                            ...
                            <div class="card">
                                <div class="card-header card-header-content-between">
                                    <h5 class="card-header-title">@lang('Filter Cars')</h5>
                ...
                <table id="datatable"
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th>@lang('Name')</th>
                            <th>@lang('Engine Type')</th>
                            <th>@lang('Transmission Type')</th>
                            <th>@lang('Doors Count')</th>
                            <th>@lang('Rent Price')</th>
                            <th>@lang('Insurance Price')</th>
                            <th>@lang('Status')</th>
            ...
            <div class="modal-content">
                ...
                <form action="" method="post" class="setRoute">
                    ...
                    <div class="modal-body">
                        <p>@lang('Do you want to delete this Car')</p>
                    </div>
    ...
    <script>
        ...
        $(document).on('ready', function() {
            ...
            $(document).on('click', '#filter_button', function() {
                ...
                datatable.ajax.url("{{ route($base_route_path.'search') }}" +
            ...
            $(document).on('click', '.inactive-multiple', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route($base_route_path.'inactive.multiple') }}",
                    data: {
                        strIds: strIds
                    },
                    datatType: 'json',
