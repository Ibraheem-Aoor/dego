...
@section('content')
    <div class="content container-fluid dashboard-height">
        ...
        <div class="row">
            @include('company.partials.dashboard.recentTran')
            @include('company.partials.dashboard.record')
        </div>

        <!-- Card -->
        {{-- Package Booking --}}
        @include('company.partials.dashboard.booking')
        {{-- Car Booking --}}
        @include('company.partials.dashboard.car_booking')
        <!-- End Card -->
