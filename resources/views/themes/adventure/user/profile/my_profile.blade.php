                                        ...
                                        <div class="btn-area">
                                            <div class="btn-area-inner d-flex">
                                                <div class="cmn-file-input">
                                                    <label for="formFile"
                                                           class="form-label"><i class="fa-regular fa-camera pe-2"></i>@lang('Select')</label>
                            ...
                            <div class="card-body pt-0">
                                <div class="profile-form-section">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="{{ old('fname', auth()->user()->firstname)  }}" name="fname"
                                                   id="firstname">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                   value="{{ old('lname', auth()->user()->lastname)  }}" name="lname"
                                                   id="lastname">
                                    ...
                                    <div class="btn-area d-flex g-3">
                                        <button type="submit" class="cmn-btn me-2">@lang('save changes')</button>
                                    </div>
                                </div>
                            </div>
                        </form>
