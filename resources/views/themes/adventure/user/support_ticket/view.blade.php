                    ...
                    <div class="inbox-wrapper">
                        <div class="top-bar">
                            <div class="d-flex align-items-center">
                                <img class="user img-fluid" src="{{ isset($ticket->admin) ? getFile(optional($ticket->admin)->image_driver, optional($ticket->admin)->image) : asset('assets/global/img/user.jpg') }}" alt="{{ @optional($ticket->admin)->name ?? 'Admin' }}" />
                                <div class="name">
                                    <a href="">{{ isset($ticket->admin) ? __(ucfirst(optional($ticket->admin)->name)) : __('Admin') }}</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-black" id="closeTicketModalLabel">@lang('Confirmation')</h4>
                ...
                <form method="get" action="{{ route('user.ticket.close', $ticket->id) }}">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn cmn-btn3" data-bs-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn btn-danger addCreateListingRoute" name="replayTicket"
