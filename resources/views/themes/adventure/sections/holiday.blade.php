    ...
    <div class="container-fluid">
        <div class="row">
            <div class="section-header text-center">
                <div class="section-subtitle">@lang(@$holiday['single']['title'])</div>
                <h2 class="section-title mx-auto">@lang(@$holiday['single']['sub_title'])</h2>
            </div>
        </div>
        <div class="row">
            <div class="owl-carousel owl-theme carousel-area1">
                @foreach($holiday['packages'] as $item)
                    <div class="item">
