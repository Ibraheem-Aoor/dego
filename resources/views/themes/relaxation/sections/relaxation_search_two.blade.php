        ...
        <div class="row">
            <div class="col-lg-10">
                <div class="search-container">
                    <div class="bg-layer" style="background: url({{ getFile(@$relaxation_search_two['single']['media']->image->driver, @$relaxation_search_two['single']['media']->image->path) }});"></div>
                    <div class="search-form">
{{--                        @$relaxation_search_two['single']['media']->button_link--}}
                        <form action="{{ route('package') }}" method="GET">
                            <div class="serach-title">
                                <h6><i class="fa-light fa-earth-americas"></i> {{ @$relaxation_search_two['single']['title'] }}</h6>
                            </div>
                            <div class="search-form-inner">
                                ...
                                <div class="date">
                                    <input class="flatpickr" name="date" id="myID" type="text" placeholder="@lang('Select Date')"/>
