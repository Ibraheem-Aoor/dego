...
@section('content')
    ...
    <section class="checkout-page">
        <div class="container">
            <form class="checkout-form row g-4" id="checkoutForm" action="{{ route('user.driver.checkout.form.store_booking' , ['id' => encrypt($object->id) , 'booking_id' => encrypt($instant->id)]) }}" method="post">
                @csrf
    ...
    <script>
        ...
        flatpickr('input[name="date"]', {
                ...
                onClose: function (selectedDates, dateStr) {
                    $.ajax({
                        url: '{{ route('user.driver.date.update') }}',
                        type: 'POST',
                        headers: {
