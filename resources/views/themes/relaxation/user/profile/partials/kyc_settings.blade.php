                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <div class="row g-4">
                                            ...
                                            <div class="btn-area mt-0">
                                                <button type="submit" class="cmn-btn2">@lang('submit')</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
`;
                                ...
                                `;
                                    ...
                                    <div class="input-box col-md-12 pb-3">
                                        <label for="" class="form-label">${value.field_label}</label>
                                        <textarea class="form-control" id="" cols="5" rows="5"
...
`;
                                    ...
                                    <div class="input-box col-12 pb-3">
                                        ...
                                        <div class="attach-file">
                                            <img id="${value.field_name}_preview" src="" alt="${value.field_label}" class="kycImagePreview"/>
