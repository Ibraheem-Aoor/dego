                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="javascript:void(0);">@lang('Agents')</a></li>
                            <li class="breadcrumb-item active" aria-current="page">@lang('Agents')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Agents List')</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Total Agents')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($agent_record[0]['totalUser'], false) }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("from") {{ fractionNumber($agent_record[0]['totalUserWithTrashed'], false) }}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{ fractionNumber($agent_record[0]['totalUserPercentage']) }}%
                              </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{fractionNumber( $agent_record[0]['activeUser'], false) }}</span>
                                <span class="text-body fs-5 ms-1">@lang("from") {{ $agent_record[0]['totalUser'] }}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{ number_format($agent_record[0]['activeUserPercentage'], 2) }}%
                              </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($agent_record[0]['todayJoin'],false) }}</span>
                                <span class="text-body fs-5 ms-1">from {{ $agent_record[0]['todayJoin'] }}</span>
                            </div>
                            <div class="col-auto">
                          <span class="badge bg-soft-info text-info p-1">
                            <i class="bi-graph-down"></i> {{ number_format($agent_record[0]['todayJoinPercentage'], 2) }}%
                          </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($agent_record[0]['deactivateUser'], false) }}</span>
                                <span class="text-body fs-5 ms-1">from {{ $agent_record[0]['totalUser'] }}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-danger text-danger p-1">{{ number_format($agent_record[0]['deactivateUserPercentage'], 2) }}%</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header card-header-content-md-between">
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    <a class="btn btn-primary btn-sm" href="{{ route('admin.agents.add') }}">
                        <i class="bi-person-plus-fill me-1"></i> @lang('Add Agent')
                    </a>
                </div>
            </div>
    ...
    <script>
        $(document).on('ready', function () {
            ...
            $(document).on('click', '#filter_button', function () {
                ...
                datatable.ajax.url("{{ route('admin.agents.search') }}" + "?filterStatus=" + filterSelectedStatus +
