                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Destination')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title text-capitalize">@lang('destination List')</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Active Destination')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                        class="js-counter display-4 text-dark">{{ $totalActiveDestination }}</span>
                                <span class="text-body fs-5 ms-1">{{'from '. $totalDestination }}</span>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Inactive Destination')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                        class="js-counter display-4 text-dark">{{ $totalInactiveDestination }}</span>
                                <span class="text-body fs-5 ms-1">{{ 'from '.$totalDestination }}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                  @if($totalInactivePercentage > 0)
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Created By Today')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                            ...
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> @lang(number_format($totalTotalCreatedTodayPercentage, 2). '%')
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Created This Month')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                            ...
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                  @if($totalTotalCreatedThisMonthPercentage > 0)
                                      <i class="bi-graph-up"></i> {{ number_format($totalTotalCreatedThisMonthPercentage, 2) }}%
                                  @else
                                      <i class="bi-graph-down"></i> {{ number_format($totalTotalCreatedThisMonthPercentage, 2) }}%
                                  @endif
                              </span>
                            </div>
                        </div>
                        ...
                        <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered filter_dropdown"
                            ...
                            <div class="card">
                                <div class="card-header card-header-content-between">
                                    <h5 class="card-header-title">@lang('Filter Destinations')</h5>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 mb-4">
                                            <span class="text-cap text-body">@lang("Title")</span>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="statusModalLabel"><i
                                class="bi bi-check2-square"></i> @lang('Package Status Confirmation')</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
        ...
        $(document).on('ready', function () {
            ...
            $(document).on('click', '.inactive-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.destination.inactiveMultiple') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
                    success: function (data) {
