                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($userKYCRecord[0]['totalKYC'], false) }}</span>
                                <span class="text-body fs-5 ms-1">{{ 'from '.$userKYCRecord[0]['totalKYC'] }}</span>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $userKYCRecord[0]['pendingKYC'] }}</span>
                                <span class="text-body fs-5 ms-1">{{ 'from '.$userKYCRecord[0]['pendingKYC'] }}</span>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($userKYCRecord[0]['approvedKYC'], false) }}</span>
                                <span
                                    class="text-body fs-5 ms-1">{{ 'from '.fractionNumber($userKYCRecord[0]['approvedKYC'], false) }}</span>
                            </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $userKYCRecord[0]['rejectedKYC'] }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ $userKYCRecord[0]['totalKYC'] }}</span>
                            </div>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.kyc.search", $status ) }}" + "?filterVerificationType=" + verificationType +
