                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.basic.control.update') }}" method="post">
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <label for="userPaginateLabel" class="form-label">@lang('User Paginate')</label>
                                        <input type="text" class="form-control @error('user_paginate') is-invalid @enderror"
                                               name="user_paginate" id="userPaginateLabel"
                                               placeholder="User Paginate" aria-label="User Paginate" autocomplete="off"
                                               value="{{ old('user_paginate',$basicControl->user_paginate) }}">
                                        @error('user_paginate')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="color_setting">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <label for="primaryColorLabel"
                                                           class="form-label">@lang('Adventure Theme Primary Color')</label>
                                                    <input type="color"
                                                           class="form-control color-form-input @error('adventure_primary_color') is-invalid @enderror"
                                                           name="adventure_primary_color"
                                                           id="primaryColorLabel"
                                                           placeholder="Primary Color" aria-label="Primary Color"
                                                           value="{{ old('adventure_primary_color',$basicControl->adventure_primary_color) }}">
                                                    @error('adventure_primary_color')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <label for="secondaryColorLabel"
                                                           class="form-label">@lang('Adventure Theme Secondary Color')</label>
                                                    <input type="color"
                                                           class="form-control color-form-input @error('adventure_secondary_color') is-invalid @enderror"
                                                           name="adventure_secondary_color"
                                                           id="secondaryColorLabel"
                                                           placeholder="Secondary Color"
                                                           aria-label="Secondary Color"
                                                           value="{{ old('adventure_secondary_color',$basicControl->adventure_secondary_color) }}">
                                                    @error('adventure_secondary_color')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <label for="secondaryColorLabel"
                                                           class="form-label">@lang('Relaxation Theme Primary Color')</label>
                                                    <input type="color"
                                                           class="form-control color-form-input @error('relaxation_secondary_color') is-invalid @enderror"
                                                           name="relaxation_secondary_color"
                                                           id="secondaryColorLabel"
                                                           placeholder="Secondary Color"
                                                           aria-label="Secondary Color"
                                                           value="{{ old('relaxation_secondary_color',$basicControl->relaxation_secondary_color) }}">
                                                    @error('relaxation_secondary_color')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <label for="primaryColorLabel"
                                                           class="form-label">@lang('Relaxation Theme Secondary Color')</label>
                                                    <input type="color"
                                                           class="form-control color-form-input @error('relaxation_primary_color') is-invalid @enderror"
                                                           name="relaxation_primary_color"
                                                           id="primaryColorLabel"
                                                           placeholder="Primary Color" aria-label="Primary Color"
                                                           value="{{ old('relaxation_primary_color',$basicControl->relaxation_primary_color) }}">
                                                    @error('relaxation_primary_color')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            </div>
