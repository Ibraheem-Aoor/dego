...
@section('content')
    <div class="card card-lg mt-lg-5">
        <div class="card-body">
            ...
            @endif
            <form method="post" action="{{ route($layer.'.login.submit') }}" class="js-validate needs-validation" novalidate>
                @csrf
                ...
                <input type="text" name="guard" hidden value="{{ $layer }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        ...
                        name="username" value="{{ old('username') }}" id="signinSrEmail" autocomplete="off" tabindex="0"
                ...
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-merge" data-hs-validation-validate-class>
                        <input type="password" tabindex="1"
                            ...
                            name="password" value="{{ old('password') }}" id="signupSrPassword" placeholder="Enter Password"
                    ...
                    <span class="d-flex justify-content-end align-items-center">
                        <a class="form-label-link mb-0" href="{{ route($layer.'.password.request') }}">
                ...
                @if ($basicControl->manual_recaptcha === 1 && $basicControl->manual_recaptcha_admin_login === 1)
                    <div class="mb-4">
                        ...
                        <input type="text" tabindex="2"
                            class="form-control form-control-lg @error('captcha') is-invalid @enderror" name="captcha"
                            id="captcha" autocomplete="off" placeholder="Enter Captcha" required>
                        @error('captcha')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                            ...
                            <a class="input-group-append input-group-text" href='javascript: refreshCaptcha();'>
                ...
                <div class="form-check mb-4">
                    <input class="form-check-input" type="checkbox" name="remember_me" value="" id="termsCheckbox"
