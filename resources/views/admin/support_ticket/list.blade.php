    ...
    <div class="content container-fluid">
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang("Ticket List")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang("Ticket List")</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $ticketRecord[0]['openTicket'] }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $ticketRecord[0]['totalTicket'] }}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-warning text-warning p-1">
                                <i class="bi-graph-up"></i> {{ fractionNumber($ticketRecord[0]['openTicketPercentage']) }}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Answer Ticket")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $ticketRecord[0]['answerTicket'] }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $ticketRecord[0]['totalTicket'] }}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{ fractionNumber($ticketRecord[0]['answerTicketPercentage']) }}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Replied Ticket")</h6>

                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $ticketRecord[0]['repliedTicket'] }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $ticketRecord[0]['totalTicket'] }}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                <i class="bi-graph-down"></i> {{ fractionNumber($ticketRecord[0]['repliedTicketPercentage']) }}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Closed Ticket")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $ticketRecord[0]['closedTicket'] }}</span>
                                <span class="text-body fs-5 ms-1">from {{ $ticketRecord[0]['totalTicket'] }}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-danger text-danger p-1">{{ fractionNumber($ticketRecord[0]['closedTicketPercentage']) }}%</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                            <div class="dropdown">
                                <button type="button" class="btn btn-white btn-sm w-100"
                                        ...
                                        aria-expanded="false">
                                    <i class="bi-filter me-1 text-capitalize"></i> @lang('filter')
                                </button>
                                ...
                                <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered filter_dropdown"
                                    ...
                                    <div class="card">
                                        <div class="card-header card-header-content-between">
                                            <h5 class="card-header-title text-capitalize">@lang('filter')</h5>
                                            <button type="button"
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('SUBJECT')</span>
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <input type="text" class="form-control"
                                                                   id="subject_filter_input"
                                                                   autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
