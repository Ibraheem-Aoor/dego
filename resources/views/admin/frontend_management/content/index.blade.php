    ...
    <div class="content container-fluid">
                    ...
                    <div class="alert-box d-flex flex-wrap align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center">
                                <p class="mb-0 text-info"> @lang("This content will serve for `". ucfirst(basicControl()->theme)."` Template.")</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @if($singleContent)
            ...
            <div class="tab-content">
                @foreach($languages as $key => $language)
                    <div class="tab-pane fade @error('errActive') @if($language->id == $message) show active @endif @else @if($loop->first) show active @endif  @enderror"
                        id="nav-one-{{ $key }}"
                            ...
                            <div class="col-lg-12">
                                <div class="card card-lg mb-3 mb-lg-4">
                                    <div class="card-header">
                                        <button  class="btn btn-white btn-sm float-end contentImageInside" data-image="{{ json_encode($contentImage) }}"
                                                data-bs-toggle="tooltip" title="Content Image View"><i class="fa-regular fa-eye"></i></button>
                                    </div>
                                                    ...
                                                    @if($type == "file" && $language->default_status == 1)
                                                        <div class="col-md-4">
                                                            ...
                                                            <label class="form-check form-check-dashed"
                                                                   for="logoUploader{{$loop->index}}" id="content_img{{$loop->index}}">
                ...
                <div class="table-responsive datatable-custom">
                    <table id="datatable"
                        ...
                        @foreach($multipleContentData as $key => $data)
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
                                <td> {{ collect($data->description)->first() }}
                                    @if($data->description == null)
                                        <img src="{{ getFile($data->content->media->image->driver, $data->content->media->image->path) }}" alt="">
                                    @endif
                                </td>
                                <td>
