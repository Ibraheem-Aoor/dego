                                                ...
                                                <div class="row">
                                                    ...
                                                    @if($type == "textarea")
                                                        <div class="col-md-12 mb-4">
                                                            ...
                                                            <textarea class="summernote @error($name.'.'.$language->id) is-invalid @enderror"
                                                    ...
                                                    @if($type == 'icon' && $language->default_status == 1 )
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label
                                                                        for="{{ $name }}">@lang(stringToTitle($name))</label>
                                                                <div class="input-group ">
                                                                    <input type="text" name="{{ $name }}[{{ $language->id }}]"
                                                                           class="form-control icon @error($name.'.'.$language->id) is-invalid @enderror"
                                                                           value="{{ old($name.'.'.$language->id, isset($multipleContentData[$language->id]) ? @$multipleContentData[$language->id][0]->content->media->{$name} : '') }}">
                                                                    <div class="input-group-append">
                                                                        <button type="button" class="btn btn-outline-primary iconPicker iconpicker dropdown-toggle"
                                                                                data-icon="{{ old($name.'.'.$language->id, isset($multipleContentData[$language->id]) ? @$multipleContentData[$language->id][0]->content->media->{$name} : '') }}"
