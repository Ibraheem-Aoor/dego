                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Package SEO')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Package SEO')</h1>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-8">
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.package.seo.update', $packageSEO->id) }}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('page_title', $packageSEO->page_title) }}" autocomplete="off">
                                        @error('page_title')
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('meta_title', $packageSEO->meta_title) }}">
                                        @error('meta_title')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select" name="meta_keywords[]"
                                                ...
                                                @if($packageSEO->meta_keywords)
                                                    @foreach($packageSEO->meta_keywords as $key => $data)
                                    ...
                                    <div class="col-sm-12 mb-4">
                                        ...
                                        <textarea id="metaDescription" class="form-control" name="meta_description" placeholder="@lang("Meta Description")" rows="5">{{ old("meta_description", $packageSEO->meta_description) }}</textarea>
                                    ...
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <textarea id="ogDescription" class="form-control" name="og_description" placeholder="@lang("OG Description")" rows="4">{{ old("og_description", $packageSEO->og_description) }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="tom-select-custom tom-select-custom-with-tags">
                                        <select class="js-select form-select meta-robot-select2" autocomplete="off"
                                            ...
                                            <option
                                                value="index" {{ in_array("index", $packageSEO->metaRobots()) ? 'selected' : '' }}>
                                                @lang('Index')
                                            </option>
                                            <option
                                                value="noindex" {{ in_array("noindex", $packageSEO->metaRobots()) ? 'selected' : '' }}>
                                                @lang('No index')
                                            </option>
                                            <option
                                                value="follow" {{ in_array("follow", $packageSEO->metaRobots()) ? 'selected' : '' }}>
                                                @lang('Follow')
                                            </option>
                                            <option
                                                value="nofollow" {{ in_array("nofollow", $packageSEO->metaRobots()) ? 'selected' : '' }}>
                                                @lang('No follow')
                                            </option>
                                            <option
                                                value="noarchive" {{ in_array("noarchive", $packageSEO->metaRobots()) ? 'selected' : '' }}>
                                                @lang('No archive')
                                            </option>
                                            <option
                                                value="nosnippet" {{ in_array("nosnippet", $packageSEO->metaRobots()) ? 'selected' : '' }}>
                                                @lang('No snippet')
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-5 mb-3 mb-md-0">
                                        ...
                                        <label class="form-check form-check-dashed" for="imageUploader">
                                            <img id="SeoImg"
                                                 ...
                                                 src="{{ getFile($packageSEO->meta_image_driver, $packageSEO->meta_image, true) }}"
