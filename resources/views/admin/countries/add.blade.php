                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">@lang("Country")</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h3 class="card-title mt-2">@lang("Add Country")</h3>
                            <a href="{{ route('admin.all.country') }}" class="btn btn-info btn-sm"><i class="bi bi-arrow-left"></i>@lang("Back")</a>
                        </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="iso2" value="{{ old('iso2') }}" class="form-control" placeholder="Country Two Character ISO" aria-label="Country Two Character ISO" aria-describedby="Country Two Character ISO">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="iso3" value="{{ old('iso3') }}" class="form-control" placeholder="Country Three Character ISO" aria-label="Country Three Character ISO" aria-describedby="ISO Three">
                                        ...
                                        <div class="card-box">
                                            <div class="row g-4 mt-1">
                                                ...
                                                <div class="input-field mt-0">
                                                    ...
                                                    <img id="showImage" class="countryImage d-none" alt="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row align-items-center pt-5">
                                            <div class="col-sm mb-2 mb-sm-0 mt-3">
                                                ...
                                                <p class="fs-5 text-body mb-0">@lang('Country status enable or Disable for hide or un-hide country. ')</p>
                                            </div>
