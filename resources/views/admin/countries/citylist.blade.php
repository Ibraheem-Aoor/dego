        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">@lang("City List")</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('admin.dashboard') }}">@lang("Dashboard")</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang("City List")</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Total Cities")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $allCities }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $allCities }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Total Active Cites")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $allActiveCities }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $allCities }}</span>
                            </div>
                            <div class="col-auto">
                                @if($activeCityPercentage > 0)
                                    <span class="badge bg-soft-success text-success p-1">
                                        <i class="bi-graph-up"></i> {{ number_format($activeCityPercentage, 2) }}%
                                    </span>
                                @else
                                    <span class="badge bg-soft-danger text-danger p-1">
                                        <i class="bi-graph-down"></i> {{ number_format($activeCityPercentage , 2) }}%
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Total Inactive Cites")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $allInactiveCities }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $allCities }}</span>
                            </div>
                            <div class="col-auto">
                                @if($inactiveCityPercentage > 0)
                                    <span class="badge bg-soft-success text-success p-1">
                                        <i class="bi-graph-up"></i> {{ number_format($inactiveCityPercentage , 2) }}%
                                    </span>
                                @else
                                    <span class="badge bg-soft-danger text-danger p-1">
                                        <i class="bi-graph-down"></i> {{ number_format($inactiveCityPercentage , 2) }}%
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                            ...
                            <div class="dropdown">
                                <a href="{{ route('admin.country.state.add.city',[$country, $state]) }}" class="btn btn-primary btn-sm w-100">
                                    <i class="bi bi-plus-circle iconStyle"></i> @lang('Add City')
                                </a>
                            </div>
                            <div class="dropdown">
                                <a href="{{ route('admin.country.all.state',$country) }}" class="btn btn-btn-info btn-sm cityBack"><i class="bi bi-arrow-left iconStyle"></i>@lang("Back")</a>
                            </div>
                        </div>
                    </div>
