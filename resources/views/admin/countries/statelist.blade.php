        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">@lang("State List")</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{ route('admin.dashboard') }}">@lang("Dashboard")</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">@lang("State List")</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Total States")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalState }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $totalState }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Total Active States")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalActiveState }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $totalState }}</span>
                            </div>
                            <div class="col-auto">
                                @if($activeStatePercentage > 0)
                                    <span class="badge bg-soft-success text-success p-1">
                                        <i class="bi-graph-up"></i> {{ number_format($activeStatePercentage, 2) }}%
                                    </span>
                                @else
                                    <span class="badge bg-soft-danger text-danger p-1">
                                        <i class="bi-graph-down"></i> {{ number_format($activeStatePercentage , 2) }}%
                                    </span>
                                @endif
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-lg-4 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Total Inactive States")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalInactiveState }}</span>
                                <span class="text-body fs-5 ms-1">@lang("From") {{ $totalState }}</span>
                            </div>
                            <div class="col-auto">
                                @if($inactiveStatePercentage > 0)
                                    <span class="badge bg-soft-success text-success p-1">
                                        <i class="bi-graph-up"></i> {{ number_format($inactiveStatePercentage , 2) }}%
                                    </span>
                                @else
                                    <span class="badge bg-soft-danger text-danger p-1">
                                        <i class="bi-graph-down"></i> {{ number_format($inactiveStatePercentage , 2) }}%
                                    </span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                            ...
                            <div>
                                <a href="{{ route('admin.country.add.state',$id) }}" class="btn btn-primary btn-sm w-100">
                                    <i class="bi bi-plus-circle iconStyle"></i>@lang('Add State')
                                </a>
                            </div>
                            <div class="dropdown">
                                <a href="{{ route('admin.all.country') }}" class="btn btn-info btn-sm cityBack" ><i class="bi bi-arrow-left iconStyle"></i>@lang("Back")</a>
                            </div>
                        </div>
                    </div>
