...
@section('content')
    <div class="content container-fluid">
        <div class="row justify-content-lg-center">
            <div class="col-lg-10">
                @include('admin.baseuser_management.components.header_user_profile')
                <div class="row" id="add_kyc_form_table">
                    <div class="col-lg-12">
                        <div class="d-grid gap-3 gap-lg-5">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <h4 class="card-title mt-2">{{ trans('Send Email To ' . $user->name) }}</h4>
                                </div>
                                <div class="card-body mt-2">
                                    <form action="{{ route($base_route_path.'email.send', ['id' => $user->id , 'model' => $base_model_name]) }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="mb-3">
