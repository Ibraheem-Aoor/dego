                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                    href="javascript:void(0);">@lang($model_trans_name)</a></li>
                            <li class="breadcrumb-item active" aria-current="page">@lang($model_trans_name)</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang($model_trans_name) @lang('List')</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Total') @lang($model_trans_name)</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($user_recored[0]['totalUser'], false) }}</span>
                                <span class="text-body fs-5 ms-1">@lang('from')
                                    {{ fractionNumber($user_recored[0]['totalUserWithTrashed'], false) }}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">
                                    <i class="bi-graph-up"></i>
                                    {{ fractionNumber($user_recored[0]['totalUserPercentage']) }}%
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Active') @lang($model_trans_name)</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($user_recored[0]['activeUser'], false) }}</span>
                                <span class="text-body fs-5 ms-1">@lang('from')
                                    {{ $user_recored[0]['totalUser'] }}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">
                                    <i class="bi-graph-up"></i>
                                    {{ number_format($user_recored[0]['activeUserPercentage'], 2) }}%
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($user_recored[0]['todayJoin'], false) }}</span>
                                <span class="text-body fs-5 ms-1">from {{ $user_recored[0]['todayJoin'] }}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-info text-info p-1">
                                    <i class="bi-graph-down"></i>
                                    {{ number_format($user_recored[0]['todayJoinPercentage'], 2) }}%
                                </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Deactivate') @lang($model_trans_name)</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($user_recored[0]['deactivateUser'], false) }}</span>
                                <span class="text-body fs-5 ms-1">from {{ $user_recored[0]['totalUser'] }}</span>
                            </div>
                            <div class="col-auto">
                                <span
                                    class="badge bg-soft-danger text-danger p-1">{{ number_format($user_recored[0]['deactivateUserPercentage'], 2) }}%</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header card-header-content-md-between">
                ...
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered filter_dropdown"
                            ...
                            <div class="card">
                                <div class="card-header card-header-content-between">
                                    <h5 class="card-header-title">@lang('Filter ') @lang($model_trans_name)</h5>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 mb-4">
                                            <small class="text-cap text-body">@lang($model_trans_name) @lang(' Status')</small>
                                            <div class="tom-select-custom">
                                                <select class="js-select js-datatable-filter form-select form-select-sm"
                                                    id="select_status" data-target-column-index="4"
                                        ...
                                        <div class="col-sm-5 mb-4">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="emailFilterCheckAll">
                    ...
                    <a class="btn btn-primary btn-sm" href="{{ route($base_route_path.'add' , ['model' => $base_model_name]) }}">
                        <i class="bi-person-plus-fill me-1"></i> @lang('Add') @lang($model_trans_name)
                    </a>
                </div>
            </div>
    ...
    <script>
        $(document).on('ready', function() {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route($base_route_path.'search' , ['model' => $base_model_name]) }}",
            ...
            $(document).on('click', '#filter_button', function() {
                ...
                datatable.ajax.url("{{ route($base_route_path.'search' , ['model' => $base_model_name]) }}" + "&filterStatus=" +
                    filterSelectedStatus +
                    "&filterName=" + filterName + "&filterLocation=" + filterSelectedLocation +
                    "&filterEmailVerification=" +
                    emailVerifiedFilter + "&filterSMSVerification=" + SMSVerifiedFilter +
                    "&filterTwoFaVerification=" + TwoFaFilter).load();
            });
            ...
            $(document).on('click', '.delete-multiple', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route($base_route_path.'delete.multiple' , ['model' => $base_model_name]) }}",
                    data: {
                        strIds: strIds
                    },
                    datatType: 'json',
