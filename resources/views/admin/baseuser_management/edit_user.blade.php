        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{ route($base_route_path.'view.profile', ['id' => $user->id , 'model' => $base_model_name]) }}">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="d-grid gap-3 gap-lg-5">
                    <form action="{{ route($base_route_path.'update', ['id' => $user->id , 'model' => $base_model_name]) }}" method="post"
                    ...
                    @include('admin.baseuser_management.components.email_section')
                    @include('admin.baseuser_management.components.username_section')
                    @include('admin.baseuser_management.components.password_section')

                    {{-- @include('admin.baseuser_management.components.preferences_section')

                    @include('admin.baseuser_management.components.two_step_verify_section')

                    @include('admin.baseuser_management.components.recent_devices_section')

                    @include('admin.baseuser_management.components.delete_account_section') --}}
