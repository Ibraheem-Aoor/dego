...
@section('page_title', __('Push Notification Templates'))
@section('content')
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">@lang("Push Notification Templates")</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang("Push Notification Templates")</h1>
                </div>
            </div>
        </div>
                                    ...
                                    <table id="datatable"
                                        ...
                                        @forelse($templates as $template)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-soft-{{ $template->status['push'] == 1 ? "success" :  "danger"  }} text-{{ $template->status['push'] == 1 ? "success" :  "danger" }}">
                                                        <span class="legend-indicator bg-{{ $template->status['push'] == 1 ? "success" :  "danger" }}"></span> {{ __($template->status['push'] == 1 ? "Active" :  "Inactive") }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <a class="btn btn-white btn-sm"
                                                       href="{{ route('admin.push.notification.template.edit', $template->id) }}">
