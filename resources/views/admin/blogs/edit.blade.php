...
@section('content')
    <div class="content container-fluid">
        ...
        <form action="{{ route("admin.blog.update", [$blog->id, $defaultLanguage->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row d-flex justify-content-center">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-sm-vertical">
                                            <input type="text" class="form-control change_name_input" name="title"
                                                   id="NameLabel" value="{{ old("title", optional($blog->details)->title) }}"
                                            ...
                                            <div class="d-inline-flex">
                                                <div class="default-slug d-flex justify-content-end align-items-center">
                                                    ...
                                                    <input type="text" class="form-control" name="slug" id="newSlug"
                                                           value="{{ optional($blog->details)->slug }}" placeholder="@lang("Slug")">
                                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="description" id="summernote" rows="20">{{ old("description", optional($blog->details)->description) }}</textarea>
                                        @error("description")
                                        <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3 mb-md-0">
                                        <label for="" class="form-label">@lang("Blog Thumbnail")</label>
                                        <label class="form-check form-check-dashed" for="thumbUploader">
                                            <img id="BlogThumbImg"
                                                 class="avatar avatar-xl avatar-4x3 avatar-centered h-100 mb-2"
                                                 src="{{ getFile($blog->blogThumb_driver, $blog->blogThumb, true) }}"
                                                 alt="@lang("Breadcrumb Image")"
                                                 data-hs-theme-appearance="default">
                                            ...
                                            <span class="d-block">@lang("Browse your file here")</span>
                                            <input type="file" class="js-file-attach form-check-input"
                                                   name="blogThumb" id="thumbUploader"
                                                   data-hs-file-attach-options='{
                                                  "textTarget": "#BlogThumbImg",
                                                  "mode": "image",
                                                  "targetAttr": "src",
                                                  "allowTypes": [".png", ".jpeg", ".jpg"]
                                           }'>
                ...
                <div class="col-lg-4">
                    <div class="d-grid gap-3 gap-lg-5">
                                    ...
                                    <span class="col-8 col-sm-9 ms-0">
                                      <span class="text-dark">@lang("Blog Status")
                                          <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                             ...
                                             data-bs-original-title="@lang("Enable blog status for publish blog.")"></i></span>
                                    </span>
                                    <span class="col-4 col-sm-3 text-end">
                                        <input type="hidden" name="blog_status" value="0">
                                        <input type="checkbox" class="form-check-input" name="blog_status"
                                               id="breadcrumb" value="1" {{ $blog->blog_status == 1 ? 'checked' : '' }}>
                                    </span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title h4">@lang("Save Changes")</h2>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-start gap-2">
                                    <button type="submit" class="btn btn-primary" name="status"
                                            value="1">@lang("Save Changes")</button>
                                </div>
                            </div>
                        </div>
                    </div>
