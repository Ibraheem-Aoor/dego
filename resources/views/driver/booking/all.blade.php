        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Completed Ride')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalAcceptedBooking }}</span>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Pending Ride')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalPendingBooking }}</span>
                                <span class="text-body fs-5 ms-1">{{ 'from ' . $totalBooking }}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-warning text-warning p-1"><i
                                        class="bi-graph-up"></i>{{ number_format($totalPendingPercentage, 2) }}%</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang('Refunded Ride')</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span class="js-counter display-4 text-dark">{{ $totalRefundedBooking }}</span>
                                <span class="text-body fs-5 ms-1">{{ 'from ' . $totalBooking }}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">
            ...
            <div class="card-header card-header-content-md-between">
                <div class="mb-2 mb-md-0">
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" type="search" class="form-control" placeholder="@lang('Search Rides')"
                            aria-label="@lang('Search Rides')" autocomplete="off">
                    </div>
                </div>
                <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
                    ...
                    <div id="datatableCounterInfo2" class="d-none">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-outline-primary btn-sm" id="refund-multiple" href="javascript:void(0)"
                                data-bs-toggle="modal" data-bs-target="#refundMultipleModal">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered filter_dropdown"
                            ...
                            <div class="card">
                                <div class="card-header card-header-content-between">
                                    <h5 class="card-header-title">@lang("Filter Ride's")</h5>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-4">
                                            <span class="text-cap text-body">@lang('Car')</span>
    ...
    <script>
        ...
        $(document).on('ready', function() {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                ordering: false,
                ajax: {
                    url: "{{ route($base_route.'search', ['status' => $status, 'car' => $car_id]) }}",
            ...
            $(document).on('click', '#filter_button', function() {
                ...
                datatable.ajax.url("{{ route($base_route.'search', $status) }}" + "?filterStatus=" +
                        filterSelectedStatus + "&filterName=" + filterName +
                        "&filterStartDate=" + startDate + "&filterEndDate=" + endDate +
                        "&filterPackageName=" + filterPackageName + "&filterBookingId=" + filterBookingId)
                    .load();
            });
            ...
            $(document).on('click', '.complete-multiple', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route($base_route.'completed.multiple') }}",
                    data: {
                        strIds: strIds
                    },
                    datatType: 'json',
            ...
            $(document).on('click', '.refund-multiple', function(e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route($base_route.'refund.multiple') }}",
                    data: {
                        strIds: strIds
                    },
                    datatType: 'json',
