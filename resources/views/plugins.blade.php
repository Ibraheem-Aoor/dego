...
<script>
    ...
    @if(request()->has('theme')=='adventure')
    root.style.setProperty('--primary-color', '{{basicControl()->adventure_primary_color ?? '#16a085'}}');
    root.style.setProperty('--bg-color3', '{{basicControl()->adventure_secondary_color ?? '#03292e'}}');
    @else
    root.style.setProperty('--secondary-color', '{{basicControl()->relaxation_primary_color ?? '#033f1b'}}');
    root.style.setProperty('--praimary-color', '{{basicControl()->relaxation_primary_color ?? '#033f1b'}}');
    root.style.setProperty('--secondary-color', '{{basicControl()->relaxation_secondary_color ?? '#ff8e3f'}}');
    @endif
</script>
