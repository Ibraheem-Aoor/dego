                ...
                <div class="col-sm-6">
                    <div class="error-content">
                        ...
                        <p class="mt-3">
                            ...
                            <span class="text-gradient">`{{config('languages.langCode')[app()->currentLocale()] }}`</span> @lang('audience. We appreciate your patience as we strive to provide valuable information in your preferred language.')
                        </p>

                        @if(auth()->guard('admin')->check())
                            <div class="btn-area">
                                <a href="{{ route('admin.page.index', basicControl()->theme ?? 'relaxation') }}"
