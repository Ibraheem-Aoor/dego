...
class UsersController extends Controller
{
    ...
    public function userEdit($id)
    {
        ...
        $data['email_update_route'] = route('admin.user.email.update', $id);
        $data['username_update_route'] = route('admin.user.username.update', $id);
        $data['password_update_route'] = route('admin.user.password.update', $id);
