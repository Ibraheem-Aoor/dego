...
class CouponController extends Controller
{
    public function list()
    {
        ...
        $data['totalActiveCoupon'] = $coupon->activeCoupon;
        $data['totalInactiveCoupon'] = $coupon->inactiveCoupon;
        $data['totalCreatedToday'] = $coupon->createdToday;
        $data['totalCreatedThisMonth'] = $coupon->createdThisMonth;
