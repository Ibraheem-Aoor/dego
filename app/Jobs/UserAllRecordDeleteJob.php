...
class UserAllRecordDeleteJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        DB::table('bookings')->where('user_id', $this->user->id)->delete();
        DB::table('favourite_lists')->where('user_id', $this->user->id)->delete();
        DB::table('reviews')->where('user_id', $this->user->id)->delete();
        DB::table('review_reactions')->where('user_id', $this->user->id)->delete();
